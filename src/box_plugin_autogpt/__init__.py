...
class BoxPlugin(AbstractSingleton, metaclass=Singleton):
    """
    Box plugin for Auto-GPT.
    """

    def __init__(self):
        super().__init__()
        self._name = "autogpt-box-plugin"
        self._version = "0.1.0"
        self._description = ("Box is the content cloud, where are your files live. "
                             "This plugin allows you to pull down your files and "
                             "add it to your context so you can ask questions.")
        self.box_developer_token = os.getenv("BOX_DEVELOPER_TOKEN")
